...
\iflanguage{english}{
	...
	\todo{dezentrales Netzwerk Abb in Motivation mit aufnehmne}
	\todo{Fragestellung: Wie implementiert man den Standard effizient}
	\todo{Struktur der Arbeit beschreiben; Anfänge von}
	\todo{Motivation, Ansatz, Ergebnis}
}
