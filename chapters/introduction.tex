...
\iflanguage{english}{
	...
	%	- 	Vorstellung der Firma und Ziel der Arbeit
	Die Arbeit wird in der gemeinnützigen GmbH Human-Connection angefertigt. Hauptsächlicher Arbeitsschwerpunkt der Human-Connection gGmbH liegt in der Umsetzung und Verbreitung eines neuartigen sozialen Wissens- und Aktionsnetzwerkes welches seinen Nutzern die Möglichkeit bieten soll von der Information hin zur Aktion zu kommen. Dabei liegt das Augenmerk auf der Gemeinnützigkeit, Transparenz durch Open-Source, deutschen Serverstandorten, Kommerz-, Werbe- und Zensurfreiheit, lösungsorientiertem Handeln sowie verzicht auf Datenverkauf. Ziel der Arbeit ist es die Implementierung des förderierten Server-zu-Server Protokolls als Prototyp, maßgeschneidert auf die Anwendungsfälle der Gesellschaft, vorzunehmen. Darüber hinaus soll die Arbeit einen Überblick über die Grundlagen des Protokolls geben und wie die relevanten Bestandteile zu verstehen sind.
	% Schutzziele
