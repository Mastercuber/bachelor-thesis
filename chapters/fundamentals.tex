...
\label{ch:fundamentals}
	...
	\iflanguage{english}{
		...
		\todo{Was bedeutet global einzigartig}
		\lstinputlisting{resources/mastodon-macu.json}	
	}
	\subsection{
	...
	\iflanguage{english}{
		...
		\todo{HTTP Signaturen, fehlt in Englischer Übersetzung}
...
\section{Fediverse}
	\iflanguage{english}{
		...
		\glqq Fediverse\grqq~is a suitcase word from \glqq Federated\grqq~and \glqq Universe\grqq. Historically, the term has only included microblogging platforms that support the OStatus protocol. More about OStatus \textbf{S. \ref{subsec:ostatus}}. Meanwhile the Fediverse contains more than just microblogging platforms like Mastodon\footnote{\url{https://mastodon.social/about}} but also social networks (e.g. GNU Social\footnote{\url{https://gnu.io/social/}}), as well as \glqq Video hosting\grqq~(PeerTube\footnote{\url{https://joinpeertube.org/en/}}),\glqq Content publishing\grqq~ Platforms, like Wordpress, and many more.\cite{fediverse}
